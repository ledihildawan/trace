...
export class TraceEngine {
  ...
  init() {
    ...
    // Legacy touch and mouse gesture handlers removed.
    // InteractionPlugin now owns touch, pointer and wheel interactions.
  ...
  setupEventDelegation() {
    // Hover tooltip mouse handlers removed — InteractionPlugin owns hover/tooltip behavior.
